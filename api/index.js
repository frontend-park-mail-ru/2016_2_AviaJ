module.exports = {
    ...
    "paths": {
        ...
        "/users/id/{userId}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Неправильный формат userId",
                        "schema": {
                            "$ref": "#/definitions/ErrorList"
                        }
                    },
        ...
        "/users/login/{login}": {
            "get": {
                "summary": "Пользователь по логину",
    ...
    "definitions": {
        ...
        "ErrorCode": {
            "type": "number",
            "format": "integer",
            "description": "9: ID меньше или равен 0<br> 10: Такого логина не существует<br> 11: Неправильный пароль<br> 21: Логин занят<br> 22: E-mail уже есть в базе<br>  23: Пустой логин<br> 24: Пустой E-mail<br> 25: Пустой пароль<br> 100: Нет пользователя с таким ID<br> 101: Пользователь уже авторизован<br> 102: Пользователь не авторизован<br> 900: Неизвестная ошибка<br> 901: Метод недоступен<br> 902: Неправильный тип параметра<br> 903: Неправвильное тело запроса<br>"
        },
        "Error": {
            "type": "object",
